...
export default function RecoveryPasswordComponent({ page }: any) {
  return (
    <div className='w-[495px] h-[auto] bg-[#fff] mt-[20px] rounded-lg px-8'>
      ...
      <button className='w-full h-[50px] bg-[#053B50] rounded-lg text-white font-semibold mt-[20px] mb-[20px] hover:bg-[#053B50cc] duration-300'>Enviar código</button>
      <p className='mt-[5px] text-[#222] text-[0.9em] cursor-pointer text-center' onClick={()=>{page(0)}}>Fazer Login</p>
    </div>
  )
}
